...
export const getProfile = (username) => {
    return async (dispatch, getState) => {
        ...
        const response = await realworld.get(`profiles/${username}`,{headers,headers})
...
export const deleteComments = (slug, id) => {
    return async (dispatch, getState) => {
        ...
        dispatch({type:'DELETECMNTS',payload:response.data})
    }
}
...
export const followUser = (username) => {
    return async (dispatch, getState) => {
        const response = await realworld.post(`/profiles/${username}/follow`,{},{ headers: headers })  
...
export const unfollowUser = (username) => {
    return async (dispatch, getState) => {
        const response = await realworld.delete(`/profiles/${username}/follow`,{ headers: headers })  
